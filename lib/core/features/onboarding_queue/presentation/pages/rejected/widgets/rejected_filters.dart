...
/// Widget for the filters section of the Rejected screen
///
/// Contains search bar, profession dropdown, and sort button
class RejectedFilters extends StatelessWidget {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: PopupMenuButton<bool>(
            ...
            itemBuilder: (context) {
              final state = context.read<OnboardingQueueBloc>().state;
              final isNewest = state.rejectedSortColumnIndex == 7 && !state.rejectedSortAscending;
              final isOldest = state.rejectedSortColumnIndex == 7 && state.rejectedSortAscending;
